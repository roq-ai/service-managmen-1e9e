...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Service Managment Application`}</title>

        <meta
          name="description"
          content="Experience seamless complaint resolution with Service Management Application, where your issues are promptly dispatched to our skilled technicians and engineers, ensuring swift and efficient service closure."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556745753-b2904692b3cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZXJ2aWNlJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTQwNzU3NTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Service Managment Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless complaint resolution with Service Management Application, where your issues are promptly dispatched to our skilled technicians and engineers, ensuring swift and efficient service closure.`}
            </Text>
            <Box
