...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'complaint.create': {
    ...
    key: 'new-complaint-submitted',
    tenantPath: ['organization', 'user', 'complaint'],
    userPath: [],
  },
  'complaint.update': {
    roles: ['service-technician', 'service-engineer'],
...
const tenantRoles: string[] = ['business-owner', 'service-manager', 'service-technician', 'service-engineer'];
